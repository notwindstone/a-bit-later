...
<template>
    <div class="container  flex justify-between items-center">
        <div class="flex flex-col gap-[30px]">
            <h1 class="text-[40px] font-black"><span class="text-[#B3DE51]">Anisign</span> - Лучшие аниме сериалы фильмы</h1>
            <p class="max-w-[700px] opacity-70">Смотри аниме онлайн в хорошем качестве. Огромная коллекция сериалов и фильмов: экшен, романтика, фэнтези и комедия. Удобный поиск, плейлисты и любимые герои.</p>
        </div>
    <div class="relative group cursor-pointer w-[871px] h-[387px] select-none">
      ...
      <img
        ...
        :class="isBlinking ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'"
        draggable="false"
      >
    </div>
    </div>
...
.group:hover img:last-child { opacity: 1 !important; }
</style>